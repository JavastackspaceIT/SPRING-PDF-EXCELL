...
public class PDFBuilder extends AbstractITextPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document doc,
		...
		Font blue = new Font(FontFamily.HELVETICA, 12, Font.BOLD,
				BaseColor.BLUE);
		Chunk blueText = new Chunk("Created By Rakesh kumar singh :", blue);
		Paragraph p = new Paragraph(blueText);
		doc.add(p);
		// Added image in PDF
		Image img = Image
				.getInstance("C:/Users/Rakesh/Desktop/20140530_102537[1].jpg");
		...
		PdfPCell cell = new PdfPCell(new Paragraph("Created By Rakesh Kumar singh"));
		/*
